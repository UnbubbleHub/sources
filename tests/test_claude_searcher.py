...
class TestClaudeSearcher:
    ...
    @pytest.fixture
    def mock_web_search_result(self) -> MagicMock:
    ...
    @pytest.fixture
    def mock_response(self, mock_web_search_result: MagicMock) -> MagicMock:
...
def test_searcher_uses_env_var(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    # The client is created, we can't easily check the key but it shouldn't raise
